...
new Page({
    ...
    data: {
        table: {
            ...
            columns: [
                ...
                { field: 'createTime', title: '创建时间', filterName: 'dateFormat', filterParam: 'YYYY-MM', cellTemplate: '<span>{{row.createTime|dateFormat}}</span>' },
                {
    ...
    init : function(){
        // 渲染表格
        this.tableVm = new Table(Object.assign({
            appVm: this
        }, this.data.table));
        // 事件
        this.event();
